const menuHamburger = document.querySelector(".nav-btn");
// const navLinks = document.querySelector(".nav-links");
 ...
 menuHamburger.addEventListener('click',()=>{
        ...
        const recipes = [
          ...
          const filter_button1 = document.getElementById("filter_button1");
          const filter_button2 = document.getElementById("filter_button2");
          const filter_button3 = document.getElementById("filter_button3");
          ...
          function generateRecipeCard(recipe) {
            ...
            comment.classList.add("like-button");

            comment.textContent="🗨️";
            commentDiv.appendChild(comment);

            timeDiv.appendChild(commentDiv);
          ...
          filter_button1.addEventListener("click", () => toggleRecipeDisplay("all"));
          filter_button2.addEventListener("click", () => toggleRecipeDisplay("veg"));
          filter_button3.addEventListener("click", () => toggleRecipeDisplay("non-veg"));
